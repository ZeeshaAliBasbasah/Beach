...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.mainViewModel == variableId) {
            setMainViewModel((com.example.beach.features.viewmodel.FlightViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMainViewModel(@Nullable com.example.beach.features.viewmodel.FlightViewModel MainViewModel) {
